---
layout: release
permalink: /releases/simpleid-1.0.7/
title: SimpleID 1.0.7 released
tags: release
release_version: '1.0.7'
release_package: simpleid
package_series: '1.x'
download_title: Download SimpleID 1.0.7
download_url: http://downloads.sourceforge.net/simpleid/simpleid-1.0.7.tar.gz
release_type: 
    - bugfix
    - security
---

Version 1.0.7 of SimpleID, a simple, personal OpenID provider written in PHP, has been released.
...
### What's new in SimpleID 1.0.7

The version mainly targets bug fixes.

- Fixes issues regarding compatibility with PHP 8.x, including `composer.json`.
- Security hardening of gettext libraries.
